...
if __name__ == "__main__":
    ...
    setuptools.setup(
        name='py_stringclustering',
        version='0.1.0',
        description='Python library for string clustering.',
        long_description=LONG_DESCRIPTION,
        url='https://sites.google.com/site/anhaidgroup/projects/magellan/py_stringclustering',
